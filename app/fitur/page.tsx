...
export default function FiturTambahanPage() {
  ...
  useEffect(() => {
    // Mengecek status tema Global dari HTML utama
    setTimeout(() => {
    ...
    <div className="min-h-screen pb-24 transition-colors duration-300">
      ...
      <div className="px-5 flex flex-col gap-5">
        <div className="bg-white dark:bg-slate-800 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 flex justify-between items-center shadow-sm transition-colors duration-300">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 dark:text-slate-400 font-medium">Mode Gelap (Global)</p>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 text-center shadow-sm transition-colors duration-300">
          ...
          <div onClick={handleTaliKlik} className="w-full bg-emerald-600 dark:bg-emerald-500 hover:bg-emerald-700 dark:hover:bg-emerald-600 text-white py-12 rounded-2xl flex flex-col items-center justify-center gap-3 cursor-pointer active:scale-[0.98] transition-all shadow-md">
